    ...
    return (
        <div className="flex flex-col w-full mx-auto">
            <section className="bg-wz-bg-color h-screen flex flex-col items-center justify-center">
                <h1 className="text-3xl text-wz-main-color">The galary page will be there soon!</h1>
                ...
                <h2 className="text-wz-text-color">The WZ Gallery will contain interesting personal parts</h2>
                <h2 className="text-wz-text-color">Thank you for your interest and welcome to connect me via</h2>
                <div className="h-4"></div>
